...
export function CustomSlider({
  ...
  const [activeErrorTooltip, setActiveErrorTooltip] = useState<number | null>(
    null
  );
  ...
  React.useEffect(() => {
    ...
    return () =>
      window.removeEventListener(
        "jumpToTime",
        handleJumpToTime as EventListener
      );
  }, [handleValueChange]);
          ...
          <div className="relative w-full">
            ...
            >
              ...
              >
                {/* Background segments */}
                <div
                  className="absolute top-1/2 -translate-y-1/2 bg-slate-200 rounded-l-full h-[8px]"
                  style={{ left: "0%", width: `${inactivityStartPercent}%` }}
                />
                <div
                  className="absolute top-1/2 -translate-y-1/2 bg-slate-200 h-[3px]"
                  style={{
                ...
                />
                <div
                  className="absolute top-1/2 -translate-y-1/2 bg-slate-200 rounded-r-full h-[8px]"
                  style={{
                    left: `${inactivityEndPercent}%`,
                    width: `${100 - inactivityEndPercent}%`,
                  }}
                />
                  ...
                  <>
                    ...
                    <div
                      ...
                      style={{
                        left: `${inactivityStartPercent}%`,
                        width: `${
                          inactivityEndPercent - inactivityStartPercent
                        }%`,
                      }}
                    />
                    <div
                ...
                {events.map((event) => {
                  if (event.type === "input") {
                    const startPercent =
                      (event.startTime! / totalDuration) * 100;
                    ...
                    return (
                      <Tooltip key={event.id}>
                        ...
                        <TooltipContent>
                          <p>
                            Input: {formatTime(event.startTime!)} -{" "}
                    ...
                    <Tooltip key={event.id}>
                      <TooltipTrigger asChild>
                        <button
                          ...
                          aria-label={`${event.type} event at ${formatTime(
                            event.timestamp
                          )}`}
                        >
