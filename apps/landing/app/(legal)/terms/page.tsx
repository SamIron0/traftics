export default function TermsPage() {
  return (
    <div
      className="px-6 sm:px-8 w-full max-w-5xl mt-24 pb-32"
    ...
    >
      <div style={{ textAlign: "left" }}>
        ...
        <div data-custom-class="subtitle" style={{ lineHeight: "1.5" }}>
          <strong>Last updated</strong> <strong>December 27, 2024</strong>
        </div>
      ...
      <div style={{ textAlign: "left" }}>
        <div id="agreement" style={{ lineHeight: "1.5" }}>
          <a />
        </div>
      </div>
      <div style={{ textAlign: "left" }}>
        <div data-custom-class="body_text" style={{ lineHeight: "1.5" }}>
          ...
          <span style={{ fontSize: 15 }}>
            <span data-custom-class="body_text">
              <span style={{ fontSize: 15 }}>
                <span data-custom-class="body_text">
                  <span style={{ color: "rgb(89, 89, 89)" }}> R3T6H3</span>
                </span>
              </span>
            </span>
          </span>
      ...
      <div style={{ textAlign: "left" }}>
        ...
        <div data-custom-class="body_text" style={{ lineHeight: "1.5" }}>
          ...
          >
            You can contact us by email at samironkwe@gmail.com or by mail to{" "}
            2525 pembina hwy , Ï winnipeg R3T6H3 ,&nbsp; Canada .
          </span>
        </div>
        <div style={{ lineHeight: 1 }}>
          <br />
      ...
      <div style={{ textAlign: "left" }}>
        ...
        <div style={{ lineHeight: "1.5" }}>
          <a data-custom-class="link" href="#ppyes">
            <span style={{ color: "rgb(0, 58, 250)", fontSize: 15 }}>
              <span data-custom-class="body_text">11. PRIVACY POLICY</span>
            </span>
          </a>{" "}
      ...
      <div style={{ textAlign: "left" }}>
        ...
        <div data-custom-class="body_text" style={{ lineHeight: "1.5" }}>
          ...
          >
            ...
            please address your request to: samironkwe@gmail.com. If we ever
      ...
      <div style={{ textAlign: "left" }}>
        <div style={{ textAlign: "justify", lineHeight: "115%" }}>
          <div style={{ lineHeight: "17.25px" }}>
            ...
            <div style={{ lineHeight: "1.1", textAlign: "left" }}></div>
      ...
      <div style={{ textAlign: "left", lineHeight: "1.5" }}>
        ...
        <div data-custom-class="body_text" style={{ lineHeight: "1.5" }}>
          ...
          Services, please email us at samironkwe@gmail.com.
          <br />
        </div>
        <div data-custom-class="heading_2" style={{ lineHeight: "1.5" }}>
          <strong>
        ...
        <div style={{ textAlign: "justify", lineHeight: 1 }}>
          <div
            data-custom-class="body_text"
            style={{ lineHeight: "1.5", textAlign: "left" }}
          >
      ...
      <div style={{ textAlign: "left" }}>
        ...
        <div data-custom-class="body_text" style={{ lineHeight: "1.5" }}></div>
        <div style={{ lineHeight: "1.5" }}></div>
        <div style={{ lineHeight: "1.5" }}></div>
      </div>
      <div style={{ lineHeight: "1.5" }}></div>
      ...
      <div style={{ lineHeight: "1.5" }}></div>
      <div style={{ lineHeight: "1.5" }}></div>
      <div style={{ lineHeight: "1.5", textAlign: "left" }}></div>
      <div
        data-custom-class="heading_1"
        id="terms"
        style={{ lineHeight: "1.5", textAlign: "left" }}
      ...
      >
        ...
        >
          ...
          >
            ...
            <span style={{ fontSize: "14.6667px" }}>,&nbsp;</span>without regard
      ...
      >
        ...
        <span style={{ fontSize: 15 }}>
          ...
          rules or applicable law, the arbitration will take place in United
          States, California . Except as otherwise provided herein, the Parties
      ...
      >
        ...
        <span style={{ fontSize: 15 }}>&nbsp;located in</span> United States
        <span style={{ fontSize: 15 }}>,</span>
        &nbsp; New York
        <span style={{ fontSize: 15 }}>
      ...
      >
        ...
        >
          ...
          Legal Terms; (<span style={{ fontSize: "14.6667px" }}>4</span>) any
      ...
      >
        <span style={{ fontSize: 15 }}>
          ...
          >
            <strong>2525 pembina hwy</strong>
      ...
      >
        <span style={{ fontSize: 15 }}>
          <strong>
            <span style={{ color: "rgb(89, 89, 89)" }}>winnipeg R3T6H3</span>
          </strong>
          <strong>
      ...
      >
        <strong>
          ...
          >
            <strong>samironkwe@gmail.com</strong>
          </span>
        </strong>
      </div>
    </div>
