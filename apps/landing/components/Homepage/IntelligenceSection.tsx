      ...
      <div className="space-y-6 lg:space-y-48 max-w-lg">
        ...
        <div className="flex flex-col gap-4">
          <p className="text-lg text-muted-foreground leading-relaxed">
            Not all session are created equal and we know that, thats why we
            auto rank sessions based on priority so you can spend less time
            sifting through irrelevant data.
          </p>
        </div>
      </div>
      <div className="flex items-center justify-center">
        <div className="bg-muted  rounded-lg aspect-square md:aspect-video w-full" />
      </div>
    </div>
  );
}
